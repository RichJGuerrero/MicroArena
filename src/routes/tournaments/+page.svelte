...
<style>
	...
	.tier-item { display: flex; align-items: center; gap: var(--space-sm); font-size: 0.875rem; color: var(--text-muted); }
	...
	.tournament-card { padding: var(--space-lg); }
	...
	.tournament-card h3 { margin-bottom: var(--space-sm); font-size: 1.25rem; }
	.tournament-desc { font-size: 0.875rem; color: var(--text-secondary); margin-bottom: var(--space-md); }
	
	.tournament-meta { margin-bottom: var(--space-md); }
	.meta-row { display: flex; justify-content: space-between; font-size: 0.875rem; padding: var(--space-xs) 0; }
	.meta-label { color: var(--text-muted); }
	.meta-value { font-weight: 600; }
	
	.tournament-info { font-size: 0.875rem; color: var(--text-secondary); margin-bottom: var(--space-md); }
	.tournament-info p { margin-bottom: var(--space-xs); }
	
	.tournament-actions {
		padding-top: var(--space-md);
		border-top: 1px solid var(--border);
	}
	.action-note { font-size: 0.8125rem; color: var(--text-muted); }
	.live-indicator { color: var(--error); font-weight: 600; }
	
	@media (max-width: 768px) {
		.tier-legend { flex-direction: column; gap: var(--space-sm); }
